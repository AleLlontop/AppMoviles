    ...
    <View style={[styles.card, { backgroundColor: c.surface }]}>
      <Calendar
        ...
        theme={{
          ...
          textDisabledColor: c.textSecondary,
      ...
      <View style={styles.calendarFooter}>
        ...
        <Text style={[styles.calendarFooterText, { color: c.textSecondary }]}>{calendarData.monthTotalText}</Text>
      </View>
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  calendarCell: { width: 36, height: 40, alignItems: 'center', justifyContent: 'center' },
  calendarCellSelected: { borderWidth: 1.5, borderColor: '#A594F9', borderRadius: 6 },
  calendarCellText: { fontSize: 11 },
  calendarCellTime: { fontSize: 7 },
  calendarFooter: { marginTop: 16, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  calendarLegend: { flexDirection: 'row', gap: 2 },
